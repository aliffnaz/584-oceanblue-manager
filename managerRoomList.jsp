            ...
            <div class="row">
                ...
                <div class="col-md card card-body py-5">
                    ...
                    <div class="row mx-2">
                        <table class="table table-hover table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="text-center"><c:out value="${room.roomId}" /></td>
                                    ...
                                    <td class="text-center">
                                        <a href="managerViewRoom.jsp?id=<c:out value="${room.roomId}" />"><i class="bi bi-eye-fill"
                                                style="font-size: 20px;"></i></a>

                                    </td>
                                    <td class="text-center"><a href="StaffController?id=<c:out value="${room.roomId}" />" onclick="success()"><i class="bi bi-trash3-fill"
                                                style=" font-size: 20px;"></i></a>
                                    </td>
                                </tr>
                                                    </c:forEach>
                    ...
                    <div class="row">
                        <div class="col"></div>
                        <div class="col"></div>
                        <div class="col-2 text-center"><a class="btn btn-dark" href="managerAddRoom.html">Add</a></div>
                    </div>
                </div>
                <div class="col">
                </div>
