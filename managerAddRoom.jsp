    ...
    <header class="reveal_header" style="background-color: #24262d;">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-6">
                    <a href="index.html" class="logo"><img src="img/logo.png" width="135" height="45" alt=""></a>
                </div>
                <div class="col-6">
                    <nav>
                        <ul>
            ...
            <div class="row">
                ...
                <div class="col-md card card-body py-5">
                    <div class="row m-4">
                        ...
                        <form action="../RoomController?action=managerAddRoom" method="post">
                    ...
                    <div class="row m-3">
                        ...
                        <div class="col-8">
                            <input type="text" name="roomNum" id="" class="form-control" placeholder="1">
                        </div>
                    </div>
                    <div class="row m-3">
                        <div class="col-1"></div>
                        ...
                        <div class="col-8">
                            <input type="number" name="maxGuest" id="" class="form-control" placeholder="0">
                        </div>
                    </div>
                    <div class="row m-3">
                        <div class="col-1"></div>
                        ...
                        <div class="col-8">
                            <input type="text" name="roomRate" id="" class="form-control" placeholder="80">
                        </div>
                    </div>
                    <div class="row m-3">
                        <div class="col-1"></div>
                    ...
                    <div class="row m-3">
                        ...
                        <div class="col-8">
                            <input type="text" name="roomSize" id="" class="form-control" placeholder="22 x 28 ft">
                        </div>
                    </div>
                    <div class="row m-3">
                        <div class="col-1"></div>
                    ...
                    <div class="row m-5">
                        <div class="col text-center">
                            <button type="submit" class="btn btn-dark btn-lg"
                                style="border-radius: 3px 3px 3px 3px; height: auto; width:150px" onclick="success()">Add</button>
...
<!--                             <script>
                            ...
                            &nbsp;
                            <a href="../RoomController?action=managerRoomList" class="btn btn-danger btn-lg"
