            ...
            <div class="row">
                ...
                <div class="col-md card card-body py-5">
                    ...
                    <div class="row m-3">
                        ...
                        <div class="col-8">
                            <input type="text" name="maxGuest" value="<c:out value="${room.maxGuest}"/>" class="form-control" placeholder="4" disabled>
                        </div>
                    </div>
                    <div class="row m-3">
                        <div class="col-1"></div>
                        ...
                        <div class="col-8">
                            <input type="text" name="roomRate" value="<c:out value="${room.roomRate}"/>" class="form-control" placeholder="RM80.00" disabled>
                        </div>
                    </div>
                    <div class="row m-3">
                        <div class="col-1"></div>
                        ...
                        <div class="col-8">
                            <input type="text" name="roomType" value="<c:out value="${room.roomType}"/>" class="form-control" placeholder="Standard" disabled>
                        </div>
                    </div>
                    <div class="row m-3">
                        <div class="col-1"></div>
                        ...
                        <div class="col-8">
                            <input type="text" name="roomSize" value="<c:out value="${room.roomSize}"/>" class="form-control" placeholder="22 x 28 ft" disabled>
                        </div>
                    </div>
                    <div class="row m-5">
