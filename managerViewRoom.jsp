					...
					<div class="row m-3">
						...
						<div class="col-8">
							<input type="text" name="roomNumber"
								...
								class="form-control" placeholder="A01" disabled>
						</div>
					</div>
					<div class="row m-3">
						<div class="col-1"></div>
						...
						<div class="col-8">
							<input type="text" name="maxGuest"
								value="<c:out value="${room.maxGuest}"/>" class="form-control"
					...
					<div class="row m-3">
						...
						<div class="col-8">
							<input type="text" name="roomRate"
								value="<c:out value="${room.roomRate}"/>" class="form-control"
								placeholder="RM80.00" disabled>
						</div>
					</div>
					<div class="row m-3">
						<div class="col-1"></div>
						...
						<div class="col-8">
							<input type="text" name="roomType"
								value="<c:out value="${room.roomType}"/>" class="form-control"
					...
					<div class="row m-3">
						...
						<div class="col-8">
							<input type="text" name="roomSize"
								value="<c:out value="${room.roomSize}"/>" class="form-control"
								placeholder="22 x 28 ft" disabled>
						</div>
					</div>
					<div class="row m-5">
						<div class="col text-center">
							<a
								href="RoomController?action=managerUpdateRoomV&roomNum=<c:out value="${room.roomNum}"/>"
								class="btn btn-dark btn-lg"
								style="border-radius: 3px 3px 3px 3px; height: auto; width: 150px">Edit</a>
							&nbsp; <a
								href="RoomController?action=managerDeleteRoom&roomNum=<c:out value="${room.roomNum}"/>"
								class="btn btn-danger btn-lg"
								style="border-radius: 3px 3px 3px 3px; height: auto; width: 150px"
								onclick="success()">Delete</a>
