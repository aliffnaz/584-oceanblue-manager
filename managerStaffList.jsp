    ...
    <header class="reveal_header" style="background-color:#24262d;">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-6">
                    <a href="index.html" class="logo"><img src="img/logo_sticky.png" width="135" height="45"
                            alt=""></a>
            ...
            <div class="row">
                ...
                <div class="col-md card card-body py-5">
                    ...
                    <div class="row">
                        <div class="col"></div>
                        <div class="col"></div>
                        <div class="col-2 text-center"><a class="btn btn-dark" href="managerAddStaff.html">Add</a></div>
