...
<body class="datepicker_mobile_full">
	...
	<main>
		...
		<div class="container mt-5 mb-5 align-items-center">
			<div class="row">
				<div class="col"></div>
				<form action="ServiceController?action=managerUpdateService" method="post">
					<div class="col-md card card-body py-5">
						...
						<div class="row m-3">
							...
							<div class="col-8">
								<input type="text" name="serviceID"
									value="<c:out value="${service.serviceID}"/>" id=""
									class="form-control" value="1235002">
							</div>
						</div>
						...
						<div class="row m-3">
							...
							<div class="col-8">
								<input type="text" name="serviceName"
									value="<c:out value="${service.serviceName}"/>" id=""
									class="form-control" value="Barbecue Set">
							</div>
						</div>
						...
						<div class="row m-3">
							...
							<div class="col-8">
								<input type="text" name="serviceType"
									value="<c:out value="${service.serviceType}"/>" id=""
									class="form-control" value="Kitchen">
							</div>
						</div>
						...
						<div class="row m-3">
							...
							<div class="col-8">
								<input type="text" name="servicePrice"
									value="<c:out value="${service.servicePrice}"/>" id=""
						...
						<div class="row m-5"> 
							<div class="col text-center">
								<button href="submit" class="btn btn-dark btn-lg"
									style="border-radius: 3px 3px 3px 3px; height: auto; width: 150px">Update</button>
								&nbsp; <a href="ServiceController?action=managerServiceList"
