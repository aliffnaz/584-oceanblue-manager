			...
			<div class="row">
				...
				<div class="col-md card card-body py-5">
					...
					<div class="row m-3">
						...
						<div class="col-8">
							<input type="text" name="guestICNumber"
								value="<c:out value="${guest.guestICNumber}"/>" id=""
								class="form-control" placeholder="010205012313" disabled>
						</div>
					</div>
					...
					<div class="row m-3">
						...
						<div class="col-8">
							<input type="text" name="guestName"
								...
								class="form-control" placeholder="Haiqal" disabled>
						</div>
					</div>
					...
					<div class="row m-3">
						...
						<div class="col-8">
							<input type="text" name="guestPhoneNumber"
								value="<c:out value="${guest.guestPhoneNumber}"/>" id=""
								class="form-control" placeholder="011-17246568" disabled>
						</div>
					</div>
						...
						<div class="col-8">
							<div class="col-8">
								<input type="text" name="guestEmail"
									value="<c:out value="${guest.guestEmail}"/>" id=""
									class="form-control" placeholder="haiqalizze02@gmail.com"
									disabled>
							</div>
						</div>
					</div>
					...
					<div class="row m-3">
						...
						<div class="col-8">
							<textarea name="guestAddress" class="form-control"
								placeholder="275 Jln 4 Off Jln Chan Sow Lin, 55200 Wilayah Persekutuan Kuala Lumpur, Wilayah Persekutuan Kuala Lumpur"
					...
					<div class="row m-5">
						<div class="col-1"></div>
						<div class="col">
							<a href="./StaffController?action=managerguestlist&user=manager"
