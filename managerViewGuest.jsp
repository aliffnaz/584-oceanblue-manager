...
<body class="datepicker_mobile_full">
    ...
    <header class="reveal_header" style="background-color:#24262d;">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-6">
                    <a href="index-6.html" class="logo"><img src="img/logo_sticky.png" width="135" height="45" alt=""></a>
                </div>
                <div class="col-6">
                    <nav>
                        <ul>
    ...
    <div class="nav_panel">
        ...
        <div class="sidebar-navigation">
            <nav>
                <ul class="level-1">
                    <li class=""><a href="SidebarController?action=managerHome&user=manager&staffICNum=${staff.staffICNum}"><i class="bi bi-house" style="font-size: 25px;"></i>
                            &nbsp;Home</a></li>
                    <li class=""><a href="SidebarController?action=managerUpdateStatus&user=manager&staffICNum=${staff.staffICNum}"><i class="bi bi-clipboard-check"
                                style="font-size: 25px;"></i>&nbsp; Room Reservation</a></li>
                    <li><a href="SidebarController?action=managerStaffList&user=manager&staffICNum=${staff.staffICNum}"><i class="bi bi-person-badge"
                                style="font-size: 25px;"></i>&nbsp; Manage Staff</a></li>
                    <li><a href="SidebarController?action=managerRoomList&user=manager&staffICNum=${staff.staffICNum}"><i class="bi bi-pencil-square"
                                style="font-size: 25px;"></i>&nbsp; Manage Room</a></li>
                    <li><a href="SidebarController?action=managerServiceList&user=manager&staffICNum=${staff.staffICNum}"><i class="bi bi-nut" style="font-size: 25px;"></i>&nbsp;
                            Manage Room Service</a></li>
                    <li><a href="SidebarController?action=managerGuestList&user=manager&staffICNum=${staff.staffICNum}"><i class="bi bi-people"
                            style="font-size: 25px;"></i>&nbsp; Manage Guest</a></li>
                    <li><a href="SidebarController?action=managerGenerateReport&user=manager&staffICNum=${staff.staffICNum}"><i class="bi bi-file-earmark-bar-graph"
            ...
            <div class="row">
                ...
                <div class="col-md card card-body py-5">
                    ...
                    <div class="row m-3">
                        ...
                        <div class="col-8">
                            <input type="text" name="guestName" value="<c:out value="${guest.guestName}"/>"  id="" class="form-control" placeholder="Haiqal" disabled>
                        </div>
                    </div>
                    ...
                    <div class="row m-3">
                        ...
                        <div class="col-8">
                            <input type="text" name="guestPhoneNumber" value="<c:out value="${guest.guestPhoneNumber}"/>" id="" class="form-control" placeholder="011-17246568" disabled>
                        </div>
                    </div>
                    ...
                    <div class="row m-3">
                        ...
                        <div class="col-8">
                            <select name="guestReligion" id="" class="form-control form-select" disabled>
                                ...
                                <option value="Budha" <c:if test="${guest.guestReligion== 'Budha'}">Selected</c:if>>Budha</option>
                    ...
                    <div class="row m-3">
                        ...
                        <div class="col-8">
                            <div class="col-8">
                                <input type="text" name="guestEmail" value="<c:out value="${guest.guestEmail}"/>" id="" class="form-control" placeholder="haiqalizze02@gmail.com" disabled>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row m-3">
                        ...
                        <div class="col-8">
                            <textarea name="guestAddress" class="form-control" placeholder="275 Jln 4 Off Jln Chan Sow Lin, 55200 Wilayah Persekutuan Kuala Lumpur, Wilayah Persekutuan Kuala Lumpur" disabled><c:out value="${guest.guestAddress}"/></textarea>
                        </div>
                    </div>
                    ...
                    <div class="row m-5">
                        <div class="col-1"></div>
                        <div class="col">
                            <a href="./StaffController?action=managerguestlist&user=manager" class="btn btn-dark btn-lg"
