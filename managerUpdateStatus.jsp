							...
							<tbody>
								<c:forEach var="reservation" items="${reservations}">
									<tr>
										...
										<td class="text-center" width="100"><c:out
										...
										<td class="text-center">
											<form
												action="StaffController?action=updateStatus&user=manager">
												<div class="custom_select text-center">
													<select name="reserveStatus" id="Status" class="wide">
														<option value="">Select</option>
														<option value="Pending"
															<c:if test="${reservation.reserveStatus == 'Pending'}">Selected</c:if>>Pending
															Payment</option>
														<option value="Paid"
