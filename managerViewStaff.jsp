			...
			<div class="row">
				...
				<div class="col-md-10 card card-body py-5">
					...
					<div class="row m-3">
						...
						<div class="col-8">
							<input type="text" name="staffName"
								value="<c:out value="${staff.staffName}"/>" class="form-control"
								value="Karim bin Ikram" disabled>
						</div>
					</div>
					...
					<div class="row m-3">
						...
						<div class="col-8">
							<input type="text" name="staffICNumber"
								...
								class="form-control" value="770604051231" disabled>
						</div>
					</div>
					...
					<div class="row m-3">
						...
						<div class="col-8">
							<input type="text" name="staffAddress"
								...
								class="form-control" value="Silentmode, Bangi" disabled>
						</div>
					</div>
					...
					<div class="row m-3">
						...
						<div class="col-8">
							<input type="text" name="staffPhoneNumber"
								value="<c:out value="${staff.staffPhoneNumber}"/>"
								class="form-control" value="01234567890" disabled>
						</div>
					</div>
					...
					<div class="row m-3">
						...
						<div class="col-8">
							<input type="text" name="staffEmail"
								...
								class="form-control" value="Karikram@gmail.com" disabled>
						</div>
					</div>
					...
					<div class="row m-3">
						...
						<div class="col-8">
							<input type="password" name="staffPassword"
								...
								class="form-control" value="AnasAli@95" disabled>
						</div>
					</div>
					...
					<div class="row m-5">
						...
						<div class="col-6 text-center">
							<a
								href="StaffController?action=managerStaffUpdateV&staffICNumber=<c:out value="${staff.staffICNumber}"/>"
