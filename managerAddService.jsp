				...
				<div class="col-md card card-body py-5">
					<div class="row m-5">
						...
						<div class="col-md-8 text-center pt-3">
							<div class="">
								...
								<h1>Room Service Information</h1>
							</div>
						</div>
						<div class="col-2"></div>
					</div>
					<form action="../ServiceController?action=managerAddService" method="post">
						<div class="row m-3">
							...
							<div class="col-8">
								<input type="text" name="serviceID" id="" class="form-control"
									placeholder="S01">
							</div>
						</div>
						<div class="row m-3">
							...
							<div class="col-8">
								<input type="text" name="serviceName" id="" class="form-control"
									placeholder="Barbecue Set">
							</div>
						</div>
						<div class="row m-3">
							<div class="col-1"></div>
							...
							<div class="col-8">
								<input type="text" name="serviceType" id="" class="form-control"
									placeholder="Kitchen">
							</div>
						</div>
						<div class="row m-3">
							...
							<div class="col-8">
								<input type="text" name="servicePrice" id=""
									class="form-control" placeholder="RM15.00">
							</div>
						</div>
						<div class="row m-3">
							<div class="col-1"></div>
